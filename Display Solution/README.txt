...
### Getting Started
# To view the web page go to the servers address that it's placed on and append ../{FolderPath}/DisplaySolution.php
ex. http://localhost/Folder/DisplaySolution.php
